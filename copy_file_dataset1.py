...
path_list=['../recordData_process_annotation','../recordData_process_annotation_light_daytime','../background_aug_negative2']
dist_root_path='../recordData_process_annotation_sum_negative2'
